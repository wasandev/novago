        ...
        <card>
            <div class="w-full flex flex-wrap" cellpadding="10" cellspacing="10">
                <div class="align-top w-1/2 border-r border-b border-50">
                    <a :href="billing1" class="no-underline dim flex p-6   hover:text-blue-500">
            ...
            <div class="w-full flex flex-wrap" cellpadding="10" cellspacing="10">
                <div class="align-top w-1/2 border-r border-b border-50">
                    <a :href="billing3" class="no-underline dim flex p-6   hover:text-blue-500">
                        <div class="flex justify-center w-11 flex-no-shrink mr-6">
                            <svg class="fill-blue-400"
                            xmlns="http://www.w3.org/2000/svg"
                            width="40"
            ...
            <div class="w-full flex flex-wrap" cellpadding="10" cellspacing="10">
                <div class="align-top w-1/2 border-r border-b border-50">
                    <a :href="billing5" class="no-underline dim flex p-6   hover:text-blue-500">
                        ...
                        <div>
                            <heading :level="2" class="mb-3">รายการสินค้ามีปัญหา</heading>
                            <p class="text-90 leading-normal">
                                ค้นหา ดู รายละเอียดรายการสินค้ามีปัญหา
                            </p>
                        </div>
                    </a>
                </div>

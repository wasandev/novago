...
return [
    ...
    */
    ...
    'permissions' => [
        ...
        'view provinces' => [
            'display_name' => 'ดู',
            'description'  => 'Can view provinces',
            'group'        => 'จังหวัด',
        ],

        'create provinces' => [
            'display_name' => 'สร้าง',
            'description'  => 'Can create provinces',
            'group'        => 'จังหวัด',
        ],

        'edit provinces' => [
            'display_name' => 'แก้ไข',
            'description'  => 'Can edit provinces',
            'group'        => 'จังหวัด',
        ],

        'delete provinces' => [
            'display_name' => 'ลบ',
            'description'  => 'Can delete provinces',
            'group'        => 'จังหวัด',
        ],
        //District
        'view districts' => [
        ...
        'view sub-districts' => [
            'display_name' => 'ดู',
            'description'  => 'Can view sub districts',
            'group'        => 'ตำบล',
        ],

        'create sub-districts' => [
            'display_name' => 'สร้าง',
            'description'  => 'Can create Sub districts',
            'group'        => 'ตำบล',
        ],

        'edit sub-districts' => [
            'display_name' => 'แก้ไข',
            'description'  => 'Can edit Sub districts',
            'group'        => 'ตำบล',
        ],

        'delete sub-districts' => [
            'display_name' => 'ลบ',
            'description'  => 'Can delete Sub districts',
            'group'        => 'ตำบล',
        ],
         //Postal Code
        'view Postal-codes' => [
            'display_name' => 'ดู',
            'description'  => 'Can view Postalcode',
            'group'        => 'รหัสไปรษณีย์',
        ],

        'create Postal-codes' => [
            'display_name' => 'สร้าง',
            'description'  => 'Can create Postalcode',
            'group'        => 'รหัสไปรษณีย์',
        ],

        'edit Postal-codes' => [
            'display_name' => 'แก้ไข',
            'description'  => 'Can edit Postalcode',
            'group'        => 'รหัสไปรษณีย์',
        ],

        'delete Postal-codes' => [
            'display_name' => 'ลบ',
            'description'  => 'Can delete Postalcode',
            'group'        => 'รหัสไปรษณีย์',
        ],
        //CompanyProfile
        'view companyprofile' => [
